...
function membersEqual(obj1: MemberObject, obj2: MemberObject): boolean {
  return (
    ...
    obj1.name === obj2.name &&
    obj1.moves.length === obj2.moves.length &&
...
function teamsEqual(obj1: TeamObject, obj2: TeamObject): boolean {
  return (
    obj1.name === obj2.name &&
    obj1.trainer === obj2.trainer &&
    obj1.team.length === obj2.team.length &&
    obj1.team.every((member, i) => membersEqual(member, obj2.team[i]))
  )
}

function objectsEqual(
  obj1: BattleObject | null,
  obj2: BattleObject | null
): boolean {
  if (obj1 == null && obj2 == null) return true
  if (obj1 == null || obj2 == null) return false
  return (
    obj1.battleMusic === obj2.battleMusic &&
